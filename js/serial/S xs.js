document.addEventListener("DOMContentLoaded", () => {
    fetchMultipleData([
        ...
        { path: 'json/serial/S xs-buruaka.json', prefix: 'buruaka-', limit: 62 },
        ...
        { path: 'json/serial/S xs-love.json', prefix: 'love-', limit: 54 },
        { path: 'json/serial/S xs-series.json', prefix: 'series-', limit: 70 },
        { path: 'json/serial/S xs-others.json', prefix: 'others-', limit: 47 },
    ]);
});
